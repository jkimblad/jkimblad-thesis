...
8], 30, 30)$ and $\tau_3=([1,2], 10, 10)$ is presented in \parencite{nasrt_exact_2017}. These can be
scheduled according to figure \ref{fig:np-test_schedule} where they all meet their deadlines.
However, if $J_7$ finishes one time unit earlier $J_2$ will miss its deadline.

The scheduling graph is a \acrshort{dag} where each edge represents a scheduling decision and each
vertex represents a time-interval. 
