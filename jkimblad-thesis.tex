...
all of the new concepts and work that has been developed in the space of this thesis. Chapter
\ref{ch:results} purely shows and puts into context the results gathered during running experiments.
Chapter \ref{ch:discussion} discusses the implications of the results shown in the earlier chapter
as well as gives conclusions and further work.
...
in scheduling in embedded systems caused by shared memory. Section \ref{sec:related_work} presents
related work.
...
\begin{algorithm}
    ...
    \label{algo:aer_iip}
    \begin{algorithmic}[1]
        \Function{$aer\_iip$}{$J_i, t, \mathcal{J}^S, c$}
