...
set a lot of tasks will have the same period, thus their jobs will have the same priority, so is of
interest to further prioritise the jobs which shares the same period according to some metric. One idea
is to prioritize jobs within their period group according to their utilization. Prioritizing a low
or high utilization might prove to improve the schedulability of the system.
...
execution-phase. The jobs are created according to algorithm \ref{algo:task_transformation}.
